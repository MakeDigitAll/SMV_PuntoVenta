...
const ExcelProducts = () => {
  ...
  useEffect(() => {
    fetch('http://ec2-18-118-164-218.us-east-2.compute.amazonaws.com:4000/Productos')
  ...
  return (
    <div>
      <div>
        ...
        <Dropdown>
          <DropdownTrigger  color='primary' size={'sm'}>Export</DropdownTrigger>
