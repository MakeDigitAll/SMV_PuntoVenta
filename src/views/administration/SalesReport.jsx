...
import { MdArrowDropDown, MdCreditCard, MdMonetizationOn, MdMoney, MdMoneyOff, MdMoneyOffCsred, MdSearch } from "react-icons/md";
...
const columns = [
  ...
  { name: "Total en Pesos", uid: "totalPesos", sortable: true },
  { name: "Total en Dolares", uid: "totalDolares", sortable: true },
  { name: "Acumulado en Pesos", uid: "acumuladoPesos", sortable: true },
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredUsers = filteredUsers.filter(
        (user) =>
          user.desde.toLowerCase().includes(filterValue.toLowerCase()) +
          user.hasta.toLowerCase().includes(filterValue.toLocaleLowerCase())+
          user.sucursal.toLowerCase().includes(filterValue.toLocaleLowerCase())+
          user.vendedor.toLowerCase().includes(filterValue.toLocaleLowerCase())
      );
    }
    if (
      statusFilter !== "all" &&
      ...
      <div className="py-2 px-2 flex justify-between items-center">
        <span className="w-[30%] text-small">
          <span style={{ marginRight: "30px" }}>
            {data.length} Reportes de ventas en total
          </span>
          {selectedKeys === "all"
            ? "All items selected"
  ...
  return (
    <div style={{ marginLeft: "40px", marginRight: "40px" }}>
      ...
      >
        ...
        <TableBody emptyContent={"No sales reports found"} items={sortedItems}>
          {(item) => (
