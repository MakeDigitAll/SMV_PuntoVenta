      ...
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          ...
          <div className="flex flex-col">
            <span className="text-default-900">Datos financieros</span>
            <span className="text-default-900 text-xs">+2400 Personas</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div>
            ...
            <span className="text-default-900 text-xs">MXN</span>
          </div>
