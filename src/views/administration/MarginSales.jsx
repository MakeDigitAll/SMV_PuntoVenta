...
const columns = [
  ...
  { name: "Productos", uid: "prods", sortable: true },
  { name: "Sub Venta M.N.", uid: "subVentaMN", sortable: true },
  { name: "Sub Costo M.N.", uid: "subCostoMN", sortable: true },
  { name: "Diferencia M.N.", uid: "deficienteMN", sortable: true },
  { name: "Margen", uid: "margen", sortable: true },
    ...
    if (hasSearchFilter) {
      filteredUsers = filteredUsers.filter(
        (user) =>
          ...
          user.desde.toLowerCase().includes(filterValue.toLocaleLowerCase())+
          user.vendedor.toLowerCase().includes(filterValue.toLocaleLowerCase())+
          user.cliente.toLowerCase().includes(filterValue.toLocaleLowerCase())
      );
    }
    if (
      statusFilter !== "all" &&
      ...
      <div className="py-2 px-2 flex justify-between items-center">
        <span className="w-[30%] text-small">
          <span style={{ marginRight: "30px" }}>
            {data.length} Margen de Ventas en total
          </span>
          {selectedKeys === "all"
            ? "All items selected"
  ...
  return (
    <div style={{ marginLeft: "40px", marginRight: "40px" }}>
      ...
      >
        ...
        <TableBody emptyContent={"No sales margins found"} items={sortedItems}>
          {(item) => (
