...
import { MdArrowDropDown, MdCollections, MdCreditCard, MdEventBusy, MdSearch, MdViewDay } from "react-icons/md";
...
const columns = [
  { name: "ID", uid: "id" },
  { name: "# Pedido", uid: "numeroPedido", sortable: true },
  ...
  { name: "Dias Vencidos", uid: "diasVencidos", sortable: true },
    ...
    if (hasSearchFilter) {
      filteredUsers = filteredUsers.filter(
        (user) =>
          ...
          user.folio.toLowerCase().includes(filterValue.toLocaleLowerCase())+
          ...
          >
            <Breadcrumbs aria-label="breadcrumb" color="foreground">
              ...
              <Typography
                ...
                className="text-foreground"
              >
                <MdEventBusy sx={{ mr: 0.5 }} fontSize="inherit" />
                Cobranza del Día
              </Typography>
            </Breadcrumbs>
          </div>
      ...
      <div className="py-2 px-2 flex justify-between items-center">
        <span className="w-[30%] text-small">
          <span style={{ marginRight: "30px" }}>
            {data.length} Cobranzas en total
          </span>
          {selectedKeys === "all"
            ? "All items selected"
