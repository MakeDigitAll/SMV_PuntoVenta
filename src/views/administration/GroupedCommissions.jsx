...
const columns = [
  ...
  { name: "Ventas del dia", uid: "serie", sortable: true },
  { name: "Comision Final", uid: "detalles", sortable: true },
  { name: "Fecha", uid: "formasPago", sortable: true },
  { name: "Folio", uid: "folio", sortable: true },
  { name: "Cliente", uid: "clientes", sortable: true },
  { name: "Ventas /Descuento", uid: "relacion", sortable: true },
  { name: "% Descuento", uid: "tipo", sortable: true },
  { name: "Pago", uid: "motivo", sortable: true },
  { name: "Tipo", uid: "subtotal", sortable: true },
  { name: "Forma de Pago", uid: "impuesto", sortable: true },
  { name: "% Comision", uid: "iva", sortable: true },
  { name: "Comision", uid: "total", sortable: true },
...
export default GroupedCommissions;