  ...
  const renderCell = React.useCallback((data, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "sucursal":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small capitalize">{data.sucursal}</p>
          </div>
        );
      case "fechaAlta":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small capitalize">{data.fechaAlta}</p>
          </div>
        );
      case "refWeb":
        return (
      ...
      case "clientes":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small capitalize">{data.clientes}</p>
          </div>
        );
      case "actions":
        return (
      ...
      <div className="py-2 px-2 flex justify-between items-center">
        <span className="w-[30%] text-small text-default-400">
          <span style={{ marginRight: "30px" }}>
            {data.length} Vendedores en total
          </span>
          {selectedKeys === "all"
            ? "All items selected"
  ...
  return (
    <div style={{ marginLeft: "40px", marginRight: "40px" }}>
      ...
      >
        ...
        <TableBody
          emptyContent={"No se encuentran Vendedores"}
          items={sortedItems}
        >
          {(dato) => (
